...
class LexerTest {
	...
	void test21() throws LexicalException {
		String input = "/* Sample comment */";
		ILexer lexer = ComponentFactory.makeLexer(input);
		checkEOF(lexer.next());
	}

	@Test
	void test22() throws LexicalException {
		String input = "image my_image;";
		ILexer lexer = ComponentFactory.makeLexer(input);
	...
	@Test
	void test23() throws LexicalException {
		String input = "if (TRUE) fi";
		ILexer lexer = ComponentFactory.makeLexer(input);
	...
	@Test
	void test24() throws LexicalException {
	...
	@Test
	void test25() throws LexicalException {
		String input = "42 * 100";
		ILexer lexer = ComponentFactory.makeLexer(input);
	...
	@Test
	void test26() throws LexicalException {
	...
	@Test
	void test27() throws LexicalException {
		String input = "a && b";
		ILexer lexer = ComponentFactory.makeLexer(input);
		checkToken(IDENT, lexer.next());
	...
	@Test
	void test28() throws LexicalException {
		String input = """
				+== = == ===
				====-> - > ->>
				""";
	...
	@Test
	void test29() throws LexicalException {
		String input = "image[400, 400] img;";
		ILexer lexer = ComponentFactory.makeLexer(input);
		checkToken(RES_image, lexer.next());
		checkToken(LSQUARE, lexer.next());
		checkToken(NUM_LIT, lexer.next());
	...
	// @Test
	// void test30() throws LexicalException {
	// String input = "BLACK or WHITE";
	// ILexer lexer = ComponentFactory.makeLexer(input);
	// checkToken(CONST, lexer.next());
	...
	@Test
	void test31() throws LexicalException {
